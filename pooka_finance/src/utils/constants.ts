...
export const CONTRACT_ADDRESS_AVAX="0x4B86db27943434339bFA20e7C15c796Bbe6eE46c";
export const CONTRACT_ADDRESS_PRICE_FEED_AVAX="0x1A266991c8D1913A42fcFeC93731581Ca3CB44D4"

export const FEE_PERCENTAGE=0.0001; // 0.01%;
